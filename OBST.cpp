...
int main(){
 ...
 cout<<"Enter the probability of unsuccesful search:";
 for(i=0;i<=n;i++){
   cout<<"q["<<i<<"]";
   cin>>b[i];
...
void print(int l1, int r1){
  ...
  if(l1>=r1)
      return;
  if(r[l1][r[l1][r1]-1]!=0)
      cout<<"left child of "<<r[l1][r1]<<"::"<<r[l1][r[l1][r1]-1];
  if(r[r[l1][r1]][r1]!=0)
      cout<<"right child of "<<r[l1][r1]<<"::"<<r[r[l1][r1]][r1];
  print(l1,r[l1][r1]-1);
  print(r[l1][r1],r1);
  return;
